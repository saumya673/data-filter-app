...
export function FilterBuilder() {
    const { conditions, addCondition, removeCondition, updateCondition, clearAll } = useDynamicFilterStore();
    ...
    return (
        <Box sx={{ p: 2, mb: 2, borderRadius: 2, boxShadow: "0px 2px 8px rgba(0,0,0,0.1)", bgcolor: "white" }}>
